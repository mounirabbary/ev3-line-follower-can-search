...
- Demo links file: `video/links.md`
...
Current layout (aligned with this repository):
...
> Recommended cleanup (optional): rename `report EV3.pdf` → `report-ev3.pdf` and `video/` → `videos/`.
